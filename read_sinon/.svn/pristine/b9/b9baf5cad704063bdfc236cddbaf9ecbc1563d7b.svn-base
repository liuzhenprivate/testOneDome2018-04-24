...
<body>
	<form action="html/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="HTML_ID" id="HTML_ID" value="${pd.HTML_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">位置类型:</td>
				<td><input type="text" name="PLACE_TYPE" id="PLACE_TYPE" value="${pd.PLACE_TYPE}" maxlength="32" placeholder="这里输入位置类型" title="位置类型"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">页面状态:</td>
				<td><input type="text" name="STATE" id="STATE" value="${pd.STATE}" maxlength="32" placeholder="这里输入页面状态" title="页面状态"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">访问量:</td>
				<td><input type="text" name="PVS" id="PVS" value="${pd.PVS}" maxlength="32" placeholder="这里输入访问量" title="访问量"/></td>
			</tr>
			<tr>
