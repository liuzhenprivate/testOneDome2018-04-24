package com.sinontech.controller.information.pictures;
...
import com.sinontech.util.DelAllFile;
...
import com.sinontech.service.information.pictures.PicturesService;
...
public class PicturesController extends BaseController {
	...
	@ResponseBody
	public Object save(@RequestParam(required = false) MultipartFile file,HttpServletRequest request) throws Exception {
