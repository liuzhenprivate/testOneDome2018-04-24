...
<body>
	<form action="countday/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="COUNT_DAY_ID" id="COUNT_DAY_ID" value="${pd.COUNT_DAY_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">统计日期:</td>
				<td><input type="text" name="COUNT_DAY" id="COUNT_DAY" value="${pd.COUNT_DAY}" maxlength="32" placeholder="这里输入统计日期" title="统计日期"/></td>
			</tr>
			<tr>
