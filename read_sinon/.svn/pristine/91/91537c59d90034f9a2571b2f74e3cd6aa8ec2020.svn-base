	...
	<form action="articlecategory/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input type="text" name="CATEGORY" id="CATEGORY" value="${pd.CATEGORY}" maxlength="32" placeholder="这里输入类目名称" title="类目名称"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">状态(0正常1隐藏2删除):</td>
				<td><input type="number" name="STATE" id="STATE" value="${pd.STATE}" maxlength="32" placeholder="这里输入状态(0正常1隐藏2删除)" title="状态(0正常1隐藏2删除)"/></td>
			</tr>
			<tr>
