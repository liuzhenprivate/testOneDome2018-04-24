package com.sinontech.controller.read.account;
...
public class AccountController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("read/account/account_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("read/account/account_edit");
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var1", varOList.get(i).get("ACCOUNT_ID").toString());	//1
				vpd.put("var2", varOList.get(i).getString("ACCOUNT_NAME"));	//2
				vpd.put("var3", varOList.get(i).getString("CARD_NUM"));	//3
				vpd.put("var4", varOList.get(i).getString("OPEN_CARD"));	//4
