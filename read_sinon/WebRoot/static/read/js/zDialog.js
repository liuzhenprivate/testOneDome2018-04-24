 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'static/read/images/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="40"  ><div style="width: 13px;"></div></td>\
      <td height="40" style="background:#f37526;"><div style="margin-left: 20px; float: left; font-size: 14px; color:#fff;"><span style="display:inline-block;height:40px;line-height:40px" id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" style="cursor:pointer;width:12px;height:13px;float:right;margin-top:14px;margin-right:20px;background:url(static/read/images/myPic19.png) left top no-repeat"></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" ></td>\
