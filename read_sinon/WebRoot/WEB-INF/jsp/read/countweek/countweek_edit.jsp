...
<body>
	<form action="countweek/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="COUNNT_WEEK_ID" id="COUNNT_WEEK_ID" value="${pd.COUNNT_WEEK_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">开始日期:</td>
				<td><input type="text" name="START_DATE" id="START_DATE" value="${pd.START_DATE}" maxlength="32" placeholder="这里输入开始日期" title="开始日期"/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">结束日期:</td>
				<td><input type="text" name="END_DATE" id="END_DATE" value="${pd.END_DATE}" maxlength="32" placeholder="这里输入结束日期" title="结束日期"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">更新日期:</td>
				<td><input type="text" name="UPDATE_TIME" id="UPDATE_TIME" value="${pd.UPDATE_TIME}" maxlength="32" placeholder="这里输入更新日期" title="更新日期"/></td>
			</tr>
			<tr>
