...
<body>
	<form action="webchatreply/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" name="KEYWORDS" id="KEYWORDS" value="${pd.KEYWORDS}" maxlength="32" placeholder="这里输入关键词" title="关键词"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">有效时间:</td>
				<td><input type="text" name="VALID_HOURS" id="VALID_HOURS" value="${pd.VALID_HOURS}" maxlength="32" placeholder="这里输入有效时间" title="有效时间"/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">失效时间:</td>
				<td><input class="span10 date-picker" name="LOSE_TIME" id="LOSE_TIME" value="${pd.LOSE_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="失效时间" title="失效时间"/></td>
			</tr>
			<tr>
