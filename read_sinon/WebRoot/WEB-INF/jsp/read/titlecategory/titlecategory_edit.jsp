...
<body>
	<form action="titlecategory/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="TITLECATEGORY_ID" id="TITLECATEGORY_ID" value="${pd.TITLECATEGORY_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">类目名称:</td>
				<td><input type="text" name="CATEGORY_NAME" id="CATEGORY_NAME" value="${pd.CATEGORY_NAME}" maxlength="32" placeholder="这里输入类目名称" title="类目名称"/></td>
			</tr>
			<tr>
