...
@Entity(name = "TB_COUNT_WEEK")
public class CountWeek {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "COUNT_WEEK_ID")
	private long id;
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((stratDate == null) ? 0 : stratDate.hashCode());
		result = prime * result
	...
	public String toString() {
		return "CountWeek [id=" + id + ", channelId=" + channelId
				...
				+ ", stratDate=" + stratDate + ", endDate=" + endDate
