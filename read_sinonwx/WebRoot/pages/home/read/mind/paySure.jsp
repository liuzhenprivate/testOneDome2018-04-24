...
<body style="background: #f8f8f8;">
	<div class="openVipT">
		<h2>￥<span>${rechargeset.money/100 }</span></h2>
		<p>${rechargeset.bookCurrency }
		<c:if test="${rechargeset.bookCurrencyGift>0 }">
		+${rechargeset.bookCurrencyGift }
		</c:if>
		阅读币</p>
	</div>
	<div class="openVipC clearfix">
		<span>微信支付</span>
		<img src="pages/home/read/images/myPic80.png" alt="" />
	</div>
	<div style="height: 1.2rem;"></div>
	<div class="reviewBtn" onclick="pay()">提&nbsp;&nbsp;&nbsp;交</div>
	<script>
		$('.openVipC img').click(function(){
			if($(this).attr('src')=='pages/home/read/images/myPic80.png'){
				$(this).attr('src','pages/home/read/images/myPic75.png');
				$('.reviewBtn').css('background','#f37526');
			}else{
				$(this).attr('src','pages/home/read/images/myPic80.png');
			...
			//alert('${appId}'+"=timeStamp="+"${timeStamp}"+"=nonceStr="+"${nonceStr}"+"=prepayId=="+"${prepayId}"+"=paySign="+"${paySign}");
		       ...
		       function(res){  
		           ...
		           if(res.err_msg == "get_brand_wcpay_request:ok" ) {
		        	   save(1);
		        	   //重定向到发起页面(如果带过来的url不为null，则重定向到阅读页面)
		        	   //alert("ok");
